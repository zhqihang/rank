...
class Company(models.Model):
    ...
    assets = models.FloatField(verbose_name="资产总额",default=0)
    income = models.FloatField(verbose_name="营业收入",default=0)
    yield_rate = models.FloatField(verbose_name="净资产收益率",default=0)
    total_content = models.FloatField(verbose_name="科技创新总含量",default=0)
    capital = models.FloatField(verbose_name="注册资本",default=0)
    range = models.CharField(verbose_name="经营范围",max_length=1000,default=None)
    Introduction = models.CharField(verbose_name="简介",max_length=500,default=None)
